CREATE SCHEMA cardproc;

CREATE TABLE cardproc.cards (
...
CREATE TABLE cardproc.transactions (
    id               UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE cardproc.webhook_deliveries (
    id              UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    url             TEXT NOT NULL,
...
CREATE INDEX idx_cardproc_webhook_deliveries_due
