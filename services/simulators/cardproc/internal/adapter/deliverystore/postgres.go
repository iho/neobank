...
// cardproc.webhook_deliveries table, so async delivery state (capture,
// reversal) survives simulator restarts.
...
func toDelivery(row sqlc.CardprocWebhookDelivery) vendorsim.Delivery {
